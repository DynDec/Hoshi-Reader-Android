...
internal object ReaderPaginationScripts {
    ...
    fun shellScriptWithRestoreToken(
        ...
        val body = template
            ...
            .replace("__HOSHI_VERTICAL_PADDING_BLOCK_RATIO__", (settings.effectiveVerticalPadding / 200.0).toString())
            .replace("__HOSHI_VERTICAL_PADDING_GAP_RATIO__", (settings.effectiveVerticalPadding / 100.0).toString())
